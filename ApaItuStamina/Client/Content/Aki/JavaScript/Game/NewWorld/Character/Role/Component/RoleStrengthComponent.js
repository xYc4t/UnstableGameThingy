...
var __decorate =
	...
	function (t, e, i, s) {
		var r,
			n = arguments.length,
			h = n < 3 ? e : null === s ? (s = Object.getOwnPropertyDescriptor(e, i)) : s;
		if ("object" == typeof Reflect && "function" == typeof Reflect.decorate) h = Reflect.decorate(t, e, i, s);
		else for (var a = t.length - 1; 0 <= a; a--) (r = t[a]) && (h = (n < 3 ? r(h) : 3 < n ? r(e, i, h) : r(e, i)) || h);
		return 3 < n && h && Object.defineProperty(e, i, h), h;
	};
Object.defineProperty(exports, "__esModule", { value: !0 }),
	(exports.RoleStrengthComponent = exports.STRENGTH_TOLERANCE = void 1);
...
let RoleStrengthComponent = class RoleStrengthComponent extends EntityComponent_1.EntityComponent {
	constructor() {
		super(...arguments),
			...
			(this.IJo = -0),
			(this.TJo = (t, e) => {
				if (this.nat?.GetPlayerId() === ModelManager_1.ModelManager.CreatureModel.GetPlayerId() && e)
					switch (this.YDo.PositionState) {
						case CharacterUnifiedStateTypes_1.ECharPositionState.Ground:
							return (
								this.YDo.MoveState === CharacterUnifiedStateTypes_1.ECharMoveState.Sprint &&
									this.YDo.SetMoveState(CharacterUnifiedStateTypes_1.ECharMoveState.Run),
						...
						case CharacterUnifiedStateTypes_1.ECharPositionState.Air:
							var i;
							return (
								this.YDo.MoveState === CharacterUnifiedStateTypes_1.ECharMoveState.Glide &&
						...
						case CharacterUnifiedStateTypes_1.ECharPositionState.Water:
							this.Ste.ContainsTagById(400631093) ||
								(ModelManager_1.ModelManager.FormationModel?.GetCurrentEntity?.Id === this.Entity.Id &&
									this.Entity.CheckGetComponent(171)?.Drowning());
					}
			}),
			(this.zUo = (t, e) => {
				this.YDo.PositionState !== CharacterUnifiedStateTypes_1.ECharPositionState.Water &&
					this.fte.IsMoveAutonomousProxy &&
					this.NewMoveStateStrengthDecrease(e);
			}),
			(this.LJo = t => {
				// this.DXr.RemoveBuffByHandle(this.yJo), t !== BigInt(0) && this.UpdateStrengthDecrease(t);
			}),
			(this.ZUo = (t, e) => {
				var i = FormationAttributeController_1.FormationAttributeController.GetValue(1);
				switch (
					(t === CharacterUnifiedStateTypes_1.ECharPositionState.Water && this.DXr.RemoveBuffByHandle(this.yJo),
					...
					// 		this.DXr.AddBuff(CharacterBuffIds_1.buffId.AirStrengthDecreaseRetain, {
					// 			InstigatorId: this.DXr.CreatureDataId,
					// 			Reason: "进入空中状态"
					// 		}),
					// 		this.ToggleStrengthForbiddenGe(CharacterBuffIds_1.buffId.AirStrengthRecoverForbidden);
					// 	break;
					// case CharacterUnifiedStateTypes_1.ECharPositionState.Water:
					// case CharacterUnifiedStateTypes_1.ECharPositionState.Climb:
					// 	this.ToggleStrengthForbiddenGe(CharacterBuffIds_1.buffId.WaterClimbStrengthForbidden);
					// 	break;
					// case CharacterUnifiedStateTypes_1.ECharPositionState.Ground:
					// 	this.DJo();
				}
	...
	OnStart() {
		return (
			...
			EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.CharOnPositionStateChanged, this.ZUo),
			EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.CharSwimStrengthChanged, this.LJo),
			...
			EventSystem_1.EventSystem.AddWithTarget(this.Entity, EventDefine_1.EEventName.RoleOnStateInherit, this.Vwo),
			!0
		);
	}
	OnEnd() {
		return (
			...
			FormationAttributeController_1.FormationAttributeController.RemoveThresholdListener(1, this.TJo),
			EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.RoleOnStateInherit, this.Vwo),
			EventSystem_1.EventSystem.RemoveWithTarget(this.Entity, EventDefine_1.EEventName.CharSwimStrengthChanged, this.LJo),
			!0
		);
	}
	RJo() {}
	EmptyStrengthPunish() {
		// this.DXr.HasBuffAuthority() &&
		// 	this.DXr.GetBuffTotalStackById(CharacterBuffIds_1.buffId.EmptyStrengthPunish) < 1 &&
	...
	NewMoveStateStrengthDecrease(t) {
		...
		// 		return void this.UpdateStrengthDecrease(CharacterBuffIds_1.buffId.SprintCost);
...
(RoleStrengthComponent.ForbidStrengthRecoveryTimeExtra = 0.5),
	(RoleStrengthComponent = __decorate([(0, RegisterComponent_1.RegisterComponent)(88)], RoleStrengthComponent)),
